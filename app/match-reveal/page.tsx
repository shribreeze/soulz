        ...
        >
          ...
          <div className="flex gap-4 mb-8 justify-center">
            <motion.button
              ...
              animate={{
                borderColor: activeTab === "match" ? "rgba(255, 153, 204, 0.8)" : "rgba(255, 153, 204, 0.2)",
                backgroundColor: activeTab === "match" ? "rgba(255, 153, 204, 0.1)" : "transparent",
              }}
            ...
            <motion.button
              ...
              animate={{
                borderColor: activeTab === "chat" ? "rgba(94, 234, 212, 0.8)" : "rgba(94, 234, 212, 0.2)",
                backgroundColor: activeTab === "chat" ? "rgba(94, 234, 212, 0.1)" : "transparent",
              }}
              className="px-6 py-3 border-2 rounded-full font-semibold text-white transition-all"
            >
              Start Chatting
              ...
              <div className="h-96 overflow-y-auto p-6 space-y-4">
                ...
                >
                  <p className="text-cyan-400 text-sm">
                    <span className="font-semibold">AI Insight:</span> Your AIs found mutual empathy alignment. You both
